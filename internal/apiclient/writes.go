...
func (c *Client) SaveLLMOutput(ctx context.Context, req wire.SaveLLMOutputRequest) (wire.SaveLLMOutputResponse, error) {
	var out wire.SaveLLMOutputResponse
	if err := c.do(ctx, http.MethodPost, "/v1/llm-outputs", req, &out); err != nil {
		return wire.SaveLLMOutputResponse{}, err
	}
	return out, nil
}
...
// episodes.
func (c *Client) SaveEpisodes(ctx context.Context, req wire.SaveEpisodesRequest) (wire.SaveEpisodesResponse, error) {
	var out wire.SaveEpisodesResponse
	if err := c.do(ctx, http.MethodPost, "/v1/episodes", req, &out); err != nil {
		return wire.SaveEpisodesResponse{}, err
	}
	return out, nil
}

// SaveSemanticFact upserts one fact.
func (c *Client) SaveSemanticFact(ctx context.Context, req wire.SaveSemanticFactRequest) (wire.SaveSemanticFactResponse, error) {
	var out wire.SaveSemanticFactResponse
	if err := c.do(ctx, http.MethodPost, "/v1/facts", req, &out); err != nil {
		return wire.SaveSemanticFactResponse{}, err
	}
	return out, nil
}
...
func (c *Client) SaveSessionOutcome(ctx context.Context, req wire.SaveSessionOutcomeRequest) error {
...
func (c *Client) SaveSessionLinks(ctx context.Context, req wire.SaveSessionLinksRequest) error {
